...
describe('ProgressService', () => {
  ...
  describe('business', () => {
    ...
    it('should fetch all progress records', () => {
      ...
      service.getAllProgress().subscribe(progress => {
    ...
    it('should get progress by course ID', () => {
      ...
      service.getProgressByCourseId(1).subscribe(progress => {
        expect(progress).toEqual(expectedProgress);
      });
    ...
    it('should get progress by ID', () => {
      ...
      service.getProgressById(1).subscribe(progress => {
        expect(progress).toEqual(expectedProgress);
      });
    ...
    it('should create a new progress record', () => {
      ...
      service.createProgress(newProgress).subscribe(progress => {
    ...
    it('should update progress', () => {
      ...
      service.updateProgress(1, updatedProgress).subscribe(progress => {
    ...
    it('should delete progress', () => {
      service.deleteProgress(1).subscribe(response => {
