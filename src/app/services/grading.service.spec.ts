...
describe('GradingService', () => {
  ...
  describe('business', () => {
    ...
    it('should fetch all grades', () => {
      ...
      service.getAllGrades().subscribe(grades => {
    ...
    it('should get grades by course ID', () => {
      ...
      service.getGradesByCourseId(1).subscribe(grades => {
        expect(grades).toEqual(expectedGrades);
      });
    ...
    it('should get grade by ID', () => {
      ...
      service.getGradeById(1).subscribe(grade => {
    ...
    it('should create a new grade', () => {
      ...
      service.createGrade(newGrade).subscribe(grade => {
    ...
    it('should update grade', () => {
      ...
      service.updateGrade(1, updatedGrade).subscribe(grade => {
    ...
    it('should delete grade', () => {
      service.deleteGrade(1).subscribe(response => {
