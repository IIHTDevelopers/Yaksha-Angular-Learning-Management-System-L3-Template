...
describe('EnrollmentService', () => {
  ...
  describe('business', () => {
    ...
    it('should fetch all enrollments', () => {
      ...
      service.getAllEnrollments().subscribe(enrollments => {
    ...
    it('should get enrollments by course ID', () => {
      ...
      service.getEnrollmentsByCourseId(1).subscribe(enrollments => {
        expect(enrollments).toEqual(expectedEnrollments);
      });
    ...
    it('should create a new enrollment', () => {
      ...
      service.createEnrollment(newEnrollment).subscribe(enrollment => {
    ...
    it('should update enrollment', () => {
      ...
      service.updateEnrollment(1, updatedEnrollment).subscribe(enrollment => {
    ...
    it('should delete enrollment', () => {
      service.deleteEnrollment(1).subscribe(response => {
